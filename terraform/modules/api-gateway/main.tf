...
locals {
  lambdas = {
    ...
    "HighChangeClassTime"     = "arn:aws:apigateway:us-east-2:lambda:path/2015-03-31/functions/arn:aws:lambda:us-west-2:338511414516:function:HighChangeClassTime/invocations"
    "HighMessageParticipants" = "arn:aws:apigateway:us-east-2:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-2:521089659248:function:HighMessageParticipants/invocations"
    "HighCreateLocation"      = "arn:aws:apigateway:us-east-2:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-2:521089659248:function:HighCreateLocation/invocations"
  }
}
